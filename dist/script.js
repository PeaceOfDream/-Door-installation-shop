...
var changeModalState = function changeModalState(state) {
  var windowForm = document.querySelectorAll(".balcon_icons_img"),
      ...
      windowType = document.querySelector("#view-type"),
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    close.addEventListener("click", function () {
      ...
      document.body.style.overflow = ""; // document.body.classList.add('modal-close')
    });
...
var tabs = function tabs(headerSelector, tabSelector, contentSlector, activeClass) {
  var display = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
  var header = document.querySelector(headerSelector),
      tab = document.querySelectorAll(tabSelector),
      content = document.querySelectorAll(contentSlector);
